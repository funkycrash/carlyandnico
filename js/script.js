...
'use strict';	
	...
	// 06.2 Countdown
	//================================================================================
	var theday = new Date(2023, 10, 21);	
	...
	$("#green").on( "click", function(e){
		e.preventDefault();
		$('link[rel*=skin]').remove();
		$('head').append('<link rel="stylesheet skin" href="css/skin/green/style.css" type="text/css" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="css/skin/green/navbar-style.css" type="text/css" />');
		}
		current_color = "green";
	});
	
	//Pink Purple
	$("#pink-purple").on( "click", function(e){
		e.preventDefault();
		$('link[rel*=skin]').remove();
		$('head').append('<link rel="stylesheet skin" href="css/skin/pink-purple/style.css" type="text/css" />');
		if (current_navbar == "color"){
			$('link[rel*=navbar]').remove();
			$('head').append('<link rel="stylesheet navbar" href="css/skin/pink-purple/navbar-style.css" type="text/css" />');
		}
		current_color = "pink-purple";
	});	
